...
This project will show pricing structures using piecewise functions, providing a real-world application to economics. Python will also be used to show visuals and compare different pricing, helping to show how small changes in input variables can affect costs as \enquote{\textit{The underlying approximation problems for these models are cast in a recursive form that can often be efficiently solved with dynamic programming strategies.}} \textcite{Ajou2015}. Making Python a good approach. 

\section{Conclusion}

This project will showcase how piecewise functions can be an effective way to model real-world pricing systems with different costs. Applying mathematical properties and showcasing real-world functions, the study aims to research the practical implications of piecewise pricing models.
